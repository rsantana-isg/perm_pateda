...
from perm_pateda.learning.plackett_luce import (
    LearnPlackettLuce
)
from perm_pateda.sampling.plackett_luce import (
    SamplePlackettLuce
)
...
class MEDA_D_PLACKETT_LUCE:
    """MEDA/D-PLACKETTLUCE framework for bi-objective permutation optimisation.
...
class MEDA_D_MIXTURE_PLACKETT_LUCE:
    """MEDA/D-PLACKETTLUCE framework for bi-objective permutation optimisation.
